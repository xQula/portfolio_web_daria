...
export const translations = {
  ru: {
    ...
    hero_showreel_badge: "Шоурил 2026",
    ...
    stat_label_projects: "Завершённых проектов",
    stat_label_years: "Лет в монтаже",
    stat_label_clients: "Клиентов и брендов",
    stat_label_categories: "Направления работы",
    ...
    cta_subtitle: "Ответ в течение суток. Обсудим формат, сроки и бюджет.",
  ...
  en: {
    ...
    hero_showreel_badge: "Showreel 2026",
    ...
    stat_label_projects: "Completed projects",
    stat_label_years: "Years in editing",
    stat_label_clients: "Clients & brands",
    stat_label_categories: "Service categories",

    // Services
    services_title: "What I do",
    services_subtitle: "From film industry to social — one editing signature across every platform.",
    service_desc_cinema: "Trailers and teasers with precise dramaturgy and atmospheric sound design.",
    service_desc_brands: "Commercial videos edited to brand guidelines with sharp emphasis.",
    service_desc_music: "Rhythmic editing, speed ramping, and sync to the soundtrack.",
    service_desc_digital: "Shorts and Reels built for trending vertical formats.",
    ...
    cta_subtitle: "Reply within a day. Let's discuss format, timeline and budget.",
